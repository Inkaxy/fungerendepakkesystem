...
import { Palette, Sun, Snowflake, Leaf, Heart, Crown, Gift, Monitor, Tablet, Eye, Presentation, Zap, Coffee } from 'lucide-react';
...
const themes = {
  largeScreen: {
    name: 'Stor Skjerm',
    icon: Monitor,
    description: 'Optimalisert for store TV-skjermer og avstandslesing',
    settings: {
